      ...
      <DialogContent className="sm:max-w-[480px] p-8 rounded-[32px]">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="text-gray-500 space-y-4 mb-8">
            <p>Вы собираетесь отменить утвержденное планировочное решение.</p>
            <p className="text-sm">
              <span className="font-bold text-gray-700">Внимание:</span> Это
              действие вернет элемент в статус `&quot;На согласовании&quot;`. Любые
              изменения утвержденной планировки после согласования влекут за
              собой корректировку рабочей документации и возможный перерасчет
